---
title: "When Should You Upgrade Your Electrical Panel in Saskatoon?"
date: "2026-06-11"
...
**Breakers that trip regularly.** A breaker that trips once in a while is doing its job. A breaker that trips weekly is telling you the circuit is consistently overloaded. If multiple breakers trip or if you find yourself resetting them regularly, your panel is undersized for your actual load.
...
**Your panel is a Federal Pacific or Zinsco brand.** If your home still has a Federal Pacific "Stab-Lok" panel or a Zinsco panel, it should be replaced regardless of age or load. Both brands have documented safety issues and are no longer considered acceptable by insurers and inspectors in Saskatchewan.
...
3. The existing panel is removed and a new 200A panel is installed
4. New wiring is run where required
5. Everything is inspected by a Saskatchewan electrical inspector before power is reconnected

The job typically takes one day for a straightforward upgrade. If the service entrance wiring (the wires coming from SaskPower's meter to your panel) also needs replacing, that adds some scope but is often necessary in older homes.
...
*WLG Homes has two Saskatchewan-licensed electricians on staff. [Contact us](/contact) for a free electrical estimate in Saskatoon, Warman, or Martensville.*
